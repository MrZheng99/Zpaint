(function() {
    ...
    function Zpaint() {
        this.init = function(canvas) {
             ...
             */
            this.canvasHistory = [];
            this.canvasHistory.push(new History("init", this.ctx.getImageData(0, 0, this.w, this.h)));
            this.bind()
        }
        ...
        this.bind = function() {
            ...
            this.canvas['on' + t.EndEvent] = function(e) {
                if (t.isRect) {
                    ...
                    t.rect = {};
                    //添加撤销功能
                    t.canvasHistory.push(new History("rect", t.ctx.getImageData(0, 0, t.w, t.h)));
                } else if (t.isCircle) {
                    if (t.storage.x > e.offsetX) {
                        var pointX = t.storage.x - Math.abs(t.storage.x - e.offsetX) / 2;
                    } else {
                    ...
                    t.storage = {};
                    t.canvasHistory.push(new History("circle", t.ctx.getImageData(0, 0, t.w, t.h)));
                } else if (t.isLine) {
                    ...
                    t.lineY = [];
                    t.clickDrag = [];
                    t.canvasHistory.push(new History("line", t.ctx.getImageData(0, 0, t.w, t.h)));
                } else if (t.drawArrow) {
                    var tempObj = {
                    ...
                    t.beginPoint = {};
                    t.canvasHistory.push(new History("arrow", t.ctx.getImageData(0, 0, t.w, t.h)));
                }
                t.lock = false;
            }
        }
        ...
        this.canvasUndo = function() {
                if (this.canvasHistory.length > 1) {
                    let item = this.canvasHistory.pop();
                    switch (item.type) {
                        case "line":
                    ...
                    this.ctx.putImageData(this.canvasHistory[this.canvasHistory.length - 1].data, 0, 0);
                } else {
